...
public abstract class HHBaseRecyclerViewAdapter<T> extends
    ...
    private List<T> list;
    private HHBaseOnClickListener itemClick;
    ...
    public void setItemClick(HHBaseOnClickListener itemClick) {
     ...
     */
    @Override
    public void onBindViewHolder(HHBaseViewHolder holder, final int position) {
            ...
            if (itemClick != null) {
                ...
                holder.getConvertView().setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        itemClick.onItemLongClick(view, position);
                        return false;
                    }
                });
            }
